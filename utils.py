...
# print(clean_subtitles(open("static/transcriptions/Why following your passion is terrible advice/Why following your passion is terrible advice.srt").read()))

def sanitize(file_name):
    # remove any invalid characters
    return urllib.parse.quote("".join(c for c in file_name if c not in FORBIDDEN_FOLDER_CHARS))
